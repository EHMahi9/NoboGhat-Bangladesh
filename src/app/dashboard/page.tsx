    ...
    <div className="dashboard-body" style={{ minHeight: "calc(100vh - 70px)" }}>
      <div className="dashboard-container">
        ...
        <main className="dashboard-main">
          ...
          {/* ========================================================
              SECTION 5: PROFILE SETTINGS (Classic Style)
             ======================================================== */}
          {activeTab === "profile-settings" && (
            <section className="recent-history dashboard-section">
              <div className="section-heading">
                <div>
                  <p className="section-kicker">{lang === "bn" ? "অ্যাকাউন্ট" : "Account"}</p>
                  <h2>{lang === "bn" ? "প্রোফাইল সেটিংস" : "Profile Settings"}</h2>
                  <p>
                    {lang === "bn"
                      ? "আপনার ব্যক্তিগত তথ্য এবং পছন্দসমূহ পরিচালনা করুন।"
              ...
              <div className="booking-panel">
                <form id="profileForm" className="profile-form" onSubmit={handleSaveProfileSettings}>
                  {/* Avatar Upload */}
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "20px" }}>
                    ...
                    <label
                      ...
                      className="btn-outline"
                      style={{ cursor: "pointer", fontSize: "0.85rem", padding: "6px 14px", marginTop: "4px" }}
                    >
                      {isUploadingPic
                        ? lang === "bn"
                          ? "আপলোড হচ্ছে..."
                  ...
                  <label htmlFor="profileName">{lang === "bn" ? "পূর্ণ নাম" : "Full Name"}</label>
                  <input
                    type="text"
                    id="profileName"
                    required
                  ...
                  <label htmlFor="profilePhone">{lang === "bn" ? "মোবাইল নম্বর" : "Phone Number"}</label>
                  <input
                    type="tel"
                    id="profilePhone"
                    value={profilePhone}
                  ...
                  {profileEmail && (
                    <>
                      <label htmlFor="profileEmail">{lang === "bn" ? "নিবন্ধিত ইমেইল" : "Registered Email"}</label>
                      <input
                        type="email"
                        id="profileEmail"
                        value={profileEmail}
                        readOnly
                        style={{ backgroundColor: "#f0f4f8", cursor: "not-allowed", color: "#667f91" }}
                      />
                    </>
                  )}

                  <label htmlFor="currentPassword">{lang === "bn" ? "বর্তমান পাসওয়ার্ড" : "Current Password"}</label>
                  <input
                    type="password"
                    id="currentPassword"
                  ...
                  <label htmlFor="newPassword">{lang === "bn" ? "নতুন পাসওয়ার্ড" : "New Password"}</label>
                  <input
                    type="password"
                    id="newPassword"
                  ...
                  <button type="submit" className="btn-book" disabled={isSavingProfile}>
                    {isSavingProfile
                      ? lang === "bn"
                        ? "সংরক্ষণ হচ্ছে..."
                        : "Saving Changes..."
                ...
                {profileMessage && (
                  <p className={`booking-message ${profileMessage.type}`} style={{ display: "block" }}>
                    {profileMessage.text}
                  </p>
                )}

                <hr style={{ margin: "24px 0", border: "none", borderTop: "1px solid #dce9f1" }} />
                <h3 style={{ marginBottom: "8px", color: "#123b59", fontWeight: 700 }}>
                  {lang === "bn" ? "বিপদজনক অঞ্চল (Danger Zone)" : "Danger Zone"}
                </h3>
                <p style={{ marginBottom: "12px", color: "#667f91", fontSize: "0.9rem" }}>
                  {lang === "bn"
                    ? "স্থায়ীভাবে আপনার অ্যাকাউন্ট নিষ্ক্রিয় করুন। এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।"
                ...
                >
                  {lang === "bn" ? "অ্যাকাউন্ট নিষ্ক্রিয় করুন" : "Deactivate Account"}
                </button>
              </div>
            </section>
          )}
